                    ...
                    <div class="box box-danger">
                        ...
                        <div class="box-body no-padding">
                            <ul class="users-list clearfix">
                                ...
                                $amis ="SELECT * FROM user WHERE id_u IN(SELECT a2 FROM amitier WHERE a1= $id_u ) OR id_u  IN (SELECT a1 FROM amitier WHERE a2= $id_u ) AND id_u != $id_u";
                                ...
                                ?>
                                    <li> <img src="<?php echo $reponse2['image_profil'] ; ?>" alt="User Image">
                                        <a class="users-list-name" href="<?php echo BASE_URL; ?>/profil/<?php echo $reponse2['id_u'] ; ?>">
                                            <?php echo $reponse2['nom'] ; echo $reponse2['prenom'] ; ?> </a> 
                                       <span class="users-list-date"><?php echo $reponse2['date_last_co'] ; ?></span></br> <a class="label label-danger" href="<?php echo BASE_URL; ?>/supprimeramis/<?php echo $reponse2['id_u'] ; ?>">Supprimer l'amie</a> </li>
                                    </li>
                                    <?php } ?>
                            </ul>
                            <!-- /.users-list -->
