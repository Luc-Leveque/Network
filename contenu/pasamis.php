                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-danger">
                        <div class="box-header with-border">
                            <h3 class="box-title">Liste Amis</h3>
                        ...
                        <div class="box-body no-padding">
                            ...
                            $amis ="SELECT * FROM user WHERE id_u NOT IN(SELECT a2 FROM amitier WHERE a1= $id_u ) AND id_u NOT IN (SELECT a1 FROM amitier WHERE a2= $id_u ) AND id_u != $id_u";
                            ...
                            ?>
                                    <li> <img src="<?php echo $reponse2['image_profil'] ; ?>" alt="User Image">
                                        ...
                                        </a> <span class="users-list-date"><?php echo $reponse2['date_last_co'] ; ?></span></br> <a class="label label-danger" href="<?php echo BASE_URL; ?>/demandeamis/<?php echo $reponse2['id_u'] ; ?>">Envoyer une demande d'amie</a> </li>
                                    <?php } ?>
                            </ul>
                            <!-- /.users-list -->
                        </div>
