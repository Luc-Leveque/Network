                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-danger">
                        <div class="box-header with-border">
                            <h3 class="box-title">Requetes</h3>
                        ...
                        <!-- /.box-header -->
                            ...
                            <div class="box-body no-padding">
                                ...
                                $amis ="SELECT * FROM demande_amie  , user  WHERE id_u=a2 and $id_u = a1 ";

                                $amis = $bdd->query($amis);


                                while($reponse2 = $amis->fetch())
                                {

?>
                                    <li> <img src="<?php echo $reponse2['image_profil'] ; ?>" alt="User Image">
                                        <a class="users-list-name" href="<?php echo BASE_URL; ?>/profil/<?php echo $reponse2['id_u'] ; ?>">
                                            <?php echo $reponse2['nom'] ; echo $reponse2['prenom'] ; ?>
                                        </a> <span class="users-list-date"><?php echo $reponse2['date_last_co'] ; ?></span></br> <a class="label label-danger" href="<?php echo BASE_URL; ?>/supprimerrequete/<?php echo $reponse2['id_u'] ; ?>">Ne pas accepter l'invitation</a> </br>
                                        </br> <a class="label label-info" href="<?php echo BASE_URL; ?>/ajoutamis/<?php echo $reponse2['id_u'] ; ?>">ajouter l'amie</a> </li><?php } ?>
                                </ul> 
                                <!-- /.users-list -->
                            </div>
