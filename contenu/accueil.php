...
?>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <ol class="breadcrumb">
                        <li><a href="<?php echo BASE_URL; ?>/accueil"><i class="fa fa-dashboard"></i>Accueil</a></li>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="box box-warning direct-chat direct-chat-warning">
                            <div class="box-header with-border">
                                ...
                                <a class="label label-danger" href="<?php echo BASE_URL; ?>/messagerie ">Poster un message</a></br>
                            ...
                            $messages ="SELECT * FROM messages , user where id_dest = id_u  and id_dest = $id_u ";
                        ...
                        <?php echo $reponse['prenom'] ; echo $reponse['nom'] ;  ?>
                        
                        </span> <span class="direct-chat-timestamp pull-right"><?php echo $reponse['date_msg'] ?></span> </div>
                                        <!-- /.direct-chat-info --><img class="direct-chat-img" src="img/profil.png" alt="message user image">
                                        <!-- /.direct-chat-img -->
                                        <div class="direct-chat-text"> <?php echo $reponse['contenu'] ?>
                                        </div>
                                        <!-- /.direct-chat-text -->
                            <?php
                             }
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="box box-widget">
                            <div class="box-header with-border">
                            <a class="label label-danger" href="<?php echo BASE_URL; ?>/post ">Poster un post</a></br>
                            <?php
                            ...
                            {
                            ?>  </br> 
                                <div class="user-block"> <img class="img-circle" src="<?php echo $reponse['image_profil'] ?>" alt="User Image"> <span class="username"><a href="#"><?php echo $reponse['nom'];  echo $reponse['prenom'] ; ?></a></span> <span class="description"><?php echo $reponse['date_post'] ?></span> </div>
                                <!-- /.user-block -->
                                <!-- /.box-tools -->
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                ...
                                <button type="button" class="btn btn-default btn-xs"><i class="fa fa-thumbs-o-up"></i> Like</button> <span class="pull-right text-muted">45 likes - 2 comments</span>
                                 </div>
                            </div>
                            <!-- /.box-footer -->
                        </div>
